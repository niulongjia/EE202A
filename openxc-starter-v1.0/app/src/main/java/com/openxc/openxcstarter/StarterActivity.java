        ...
        DirectionFinder.AsyncResponseDirectionFinder
{
    ...
    // This is default Los Angeles coordinates.
    private double latitude_val=34.054;
    private double longitude_val=-118.245;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get Google Map Fragment to Work
    ...
    public void onMapReady(GoogleMap googleMap)
    {
        ...
        showCarMarkerOnMap();
        // Show the search circle with center at car.
        showCircleOnMap();
        // Zoom the camera to car location when map is ready.
        LatLng ll=new LatLng(latitude_val,longitude_val);
        mGoogleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(ll,14 ));

        // Create GoogleApiClient to constantly listen to the change of location.
        ...
        // The event when clicking the button.
        ...
        mfindGasStationBtn.setOnClickListener(new View.OnClickListener() {
            ...
            {
                // polylineD is transferred back from asyncGetDirectionToGasStation().
                ...
                // Given the location of car and nearest gas station, calculate the route and draw polylineD.
    ...
    // Do something when car location changed.
    @Override
    public void onLocationChanged(Location location) {
        ...
        else
        {
            ...
            // clear previous car marker and circle, but maintain the route and nearest gas station.
            removeMarkerCircle();

            showCarMarkerOnMap();
            showCircleOnMap();
            // Given the location of car, find the nearest gas station and draw marker.
    ...
    {
        // Transfer DataTransfer to AsyncTask, because Android do not allow updating UI while making internet request.
        Object[] DataTransfer = new Object[5];
        DataTransfer[0]=mGoogleMap;
        DataTransfer[1]=latitude_val; // car latitude.
        DataTransfer[2]=longitude_val; // car longitude.
    ...
    {
        // Transfer DataTransfer to AsyncTask.
        Object[] DataTransfer = new Object[3];
        DataTransfer[0]=new LatLng(latitude_val,longitude_val); // car
        DataTransfer[1]=destinationLatLng; // nearest gas station.
    ...
    // This function is needed to transfer data from asyncTask GetNearbyGasStation back to mainActivity.
    @Override
    ...
    /****************The following is needed to transfer data back to mainActivity******************/
    // This function is needed to transfer data from asyncTask DirectionFinder back to mainActivity.
    @Override
