        ...
        GetNearbyGasStation.AsyncResponseGasStation
{
    ...
    private List<Marker> markerList_unique = new ArrayList<Marker>();
...
/*        nearbyPlacesList_unique = new ArrayList<HashMap<String, String>>();
        ...
        if (markerList_unique!=null) markerList_unique.clear();
        ...
        jsonData=new ReadUrl().readFromUrl(directionUrl);
        return jsonData;
    }
    @Override
    ...
    public void nearByGasStationTransfer(Object[] transfer)
    {
        ...
        if (nearbyPlacesList!= null || nearbyPlacesList.size()>0)
        {
            for (int i=0;i<nearbyPlacesList.size();i++)
            {
                ...
                Marker nearbyMarker=markerList.get(i);
                ...
                markerList_unique.add(nearbyMarker);
            }
            ...
            transferD[4]=markerList_unique;
            transferD[5]=jsonData;
